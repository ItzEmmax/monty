...
/**
 * parse_line - Determines function to call by separating lines to tokens
 * @buffer: file line
...
/**
 * find_func - finds function for opcode
 * @opcode: opcode
...
/**
 * call_fun - Neccessary function caller.
 * @func: Points to the function called.
 * @op: opcode string.
 * @val: numerical value string.
 * @ln: line numeber.
